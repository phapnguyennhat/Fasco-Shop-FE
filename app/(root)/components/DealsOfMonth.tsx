    ...
    return (
        <section className="    max-w-[1920px] mb-[30px]  sm:mb-[50px]  md:mb-[80px] lg:mb-[150px]  ">
            <div className=" flex ml-4    2xl:ml-[136px] gap-5 ">
                {/* Left Section */}
                <div className="flex  flex-col gap-5 w-[444px]">
                    ...
                    <Link
                        href="/deal"
                        className="mx-auto sm:mx-0 bg-black min-w-[207px] text-white px-6 py-3 rounded-md text-center font-medium hover:bg-gray-800 transition-all w-max"
                    >
                        Buy Now
                    </Link>
