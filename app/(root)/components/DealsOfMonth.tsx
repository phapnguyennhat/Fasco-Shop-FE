			...
			<div className=" flex ml-4    2xl:ml-[136px] gap-5 ">
				...
				<div className="flex  flex-col gap-2 lg:gap-5 w-[444px]">
					...
					<p className="text-[#8A8A8A] mb-2 text-base leading-relaxed">
						From must-have tech gadgets to trendy fashion finds and
						home essentials, we’ve curated a lineup of discounts
						that’ll make your wallet happy. Each deal is handpicked
						to bring you the best value. Don’t wait—these steals won’t last long,
						so dive in now and snag the savings while they’re hot!
					</p>
					<Link
