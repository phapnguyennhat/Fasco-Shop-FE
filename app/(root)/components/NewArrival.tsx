    ...
    return (
		<section className=" section-page_home mb-6  md:mb-8 ">
			...
			<p className=" text-[#8A8A8A]  text-sm md:text-base text-start md:text-center max-w-[614px] mx-4 md:mx-auto ">
				We has scoured the globe to bring you standout pieces that
				blend quality, flair, and functionality. Whether you're
				refreshing your wardrobe or upgrading your space, these new
				arrivals are here to inspire. Check them out today and be the
				first to own what's next!
			</p>
